%Czcionka 12pkt
\documentclass[12pt]{report} % Zmień na {article} jeśli nie chcesz mieć dużego nagłówna nowego rozdziału głównego
...
% Jeżli nie chcesz dużego nagłówka rozdziłu głównego zmień \documentcalss na article - pierwsza linijka pliku
\include{chapter1} % ZOBACZ PLIK CHAPTER1.TEX 
